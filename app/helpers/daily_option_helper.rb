module DailyOptionHelper
	def self.option_chains
			...
			date_unix = DateTime.parse("2015-06-25 17:00:00 -0700").to_time.to_i
			stock_list.each do |stock|
					...
					begin
						...
						if (option_chain.length > 1)
							DailyOption.create!(symbol:stock.symbol, expiration_date:Date.parse("2015-06-25 17:00:00 -0700").next, option_chains:option_chain, record_date: Date.today - 1)
						end
					end
				end
	end
